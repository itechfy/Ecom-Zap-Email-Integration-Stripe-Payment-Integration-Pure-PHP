...
<html lang="en">
  <head>
    ...
    <title>Graphic Designing | Ecom Zap</title>
  </head>
  <body>
...
<section class="head d-flex wrap-flex width-80 margin-auto">
    ...
    <p class="w-black font-50-30 clrd-text" >200 <span class="dollar">$</span></p>
    </div>
</section>
      ...
      <section class="talk1">
        <div class="talk2 width-80 margin-auto d-flex wrap-flex align-center s-btw gap">
          <div class="flex-1 d-flex flex-col gap">
            ...
            You will get exceptional branding solutions including Logo design, Packaging etc.
             </p>
          ...
          <div class="choose d-flex align-center justify-center service-img3">
