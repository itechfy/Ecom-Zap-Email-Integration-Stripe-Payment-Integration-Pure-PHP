...
<html lang="en">
  <head>
    ...
    <title>Sample Testing | Ecom Zap</title>
  </head>
  <body>
...
<section class="head d-flex wrap-flex width-80 margin-auto">
    ...
    <p class="w-black font-50-30 clrd-text" >50 <span class="dollar">$</span></p>
    </div>
</section>
    ...
    <p class="font-50-30 w-extrabold d-flex align-center justify-center">
      ...
      <section class="talk1">
        <div class="talk2 width-80 margin-auto d-flex wrap-flex align-center s-btw gap">
               ...
               <ul class="s-l line-height padTop-20">
                <li> 
                  Fast & efficient customer support service. </li>
                    <li>Offices in China to accommodate your product sourcing transactions.</li>
                        <li>Fastest turnaround-time for sample testing</li>
                            <li>Affordable sample testing service.</li>
                                <li>Reliable inspections guaranteed with video proof.</li>
               </ul>
          ...
          <div class="choose d-flex align-center justify-center service-img5">
