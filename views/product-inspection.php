...
<html lang="en">
  <head>
    ...
    <title>Product Inspection | Ecom Zap</title>
  </head>
  <body>
    ...
    <p class="font-50-30 w-extrabold d-flex align-center justify-center">
      ...
      <section class="talk1">
        <div class="talk2 width-80 margin-auto d-flex wrap-flex align-center s-btw gap">
          ...
          <div class="choose d-flex align-center justify-center service-img4">
